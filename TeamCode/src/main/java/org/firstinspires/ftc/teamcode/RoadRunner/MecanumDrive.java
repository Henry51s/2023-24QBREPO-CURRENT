...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.000766990393943;
        public double lateralInPerTick = 1;
        public double trackWidthTicks = 18895.116782371868;

        // feedforward parameters (in tick units)
        public double kS = 1.898882694028742;//1.50748455405478
        public double kV = 0.00009857547963512079;//0.00010840086549546328
        public double kA = 0;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        rightBack = hardwareMap.get(DcMotorEx.class, "motor0"); //Change to rightBack
        rightFront = hardwareMap.get(DcMotorEx.class, "motor2");// Change to rightFront
        leftFront = hardwareMap.get(DcMotorEx.class, "motor3");//Change to frontLeft
        leftBack = hardwareMap.get(DcMotorEx.class, "motor1");//Change to frontRight
